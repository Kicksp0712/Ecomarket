    ...
    <>
      ...
      {posts?.length === 0 ? (
        ...
        <>
          ...
          <div id="container" className='mx-auto  my-20 grid grid-cols-1 px-8 gap-4 w-[50vw] sm:w-[99vw] sm:mx-0 lg:w-[99vw]'>
            {posts?.map((post, i) => {
              return (
                <div
                  key={`post_${i}`}
                ...
                >
                  <div className='flex space-x-1 justify-end text-gray-500  text-sm mb-2'>
